...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        while correu_ieti is None:
            #input_msg = self._get_input_message(username_field, 'Correu electrònic IETI: ')
            #correu_ieti = self.get_input_data(self.stdin, input_msg)
        ...
        nou_usuari = Usuari.objects.create_user(username='admin', correu_ieti=correu_ieti, password=password, nom=first_name, cognoms=last_name, any_naixement=any_naixement, tipus='super-usuari', is_staff=True, is_superuser=True)
